...
def pure_get_updates(self):
    ...
    file_name = f'{self.dirpath}/reports/{str(date_today)}_updates.log'

    # Check if file exists
    if not self.os.path.exists(file_name):
    ...
    while True:
        ...
        open(f'{self.dirpath}/reports/{str(date_today)}_updates_check.log', "a").write(report)
