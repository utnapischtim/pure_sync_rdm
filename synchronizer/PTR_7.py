...
class pureToInvenio:
    ...
    def get_pure_by_page(self, pag_begin, pag_end, pag_size):
        ...
        for pag in range(pag_begin, pag_end):
            ...
            # resp_json = open(self.dirpath + '/reports/pure_resp.json', 'r')             # -- TEMPORARY -- 
    ...
    def create_invenio_data(self):
            ...
            if 'personAssociations' in item:
                ...
                for i in item['personAssociations']:
                    ...
                    if 'name' in i:
                        if 'firstName' in i['name']:    self.add_field(i,   'name', ['name', 'firstName'])
                        else:                           self.data +=        '"name": "not specified", '
                    else:
                                                        self.data +=        '"name": "not specified", '
