...
#           -           -           -           -
        # # print(f'SSSSSSSSSSSSSSSS {SessionActivity.__dict__}')
...
#           -           -           -           -
        ...
        # pprint(f'SSSSSSSSSSSSSSSS {db.Column.__dict__}')
#           -           -           -           -
        # print(f'SSSSSSSSSSSSSSSS {get_identity_attributes()}')
#           -           -           -           -


        user_ip = '127.0.0.4'
        ip_ranges = [['127.0.0.3', '127.0.0.5'], ['127.0.0.7', '127.0.0.8']]
        self.visible = False
    ...
    def needs(self, record=None, **rest_over):
        ...
        # Allowed access: 
        #       - when 'ip_ranges' is in appliedRestrictions
        #       - whe user_ip is in ip_range
